...
public class HotelService implements CRUDservices<String,Hotel> {
    ...
    public void insertOne(Hotel hotel) throws SQLException {
        String req = "INSERT INTO `services`(`nom`,`description`,`prix`,`disponibilite`,`capacite`,`nombre_etoiles`,`localisation`,`type_chambre`,`type`,`img_url`) VALUES " +
    ...
    public void updateOne(String hotelName,Hotel hotel) throws SQLException {
        String req="UPDATE services SET nom='"+hotel.getNom()+"',description='"+hotel.getDescription()+"'" +
                ...
                ",nombre_etoiles='"+hotel.getNbEtoiles()+"',localisation='"+hotel.getLocalisation()+"',type_chambre='"+hotel.getChambre()+"' WHERE nom='"+hotelName+"'";
