...
@FXML
    private void openServicesDashboard() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/views/Services.fxml")
            );
    ...
    @FXML
    private void openReservationsDashboard() {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/views/Reservations.fxml")
            );
    ...
    @FXML
    private void openServicesDashboardback() {
        try {
            FXMLLoader loader = new FXMLLoader(
