...
public class WeatherData {
    ...
    private String weatherMain;       // Main weather condition (e.g., "Clear", "Clouds")
    private String weatherDescription;// Detailed description (e.g., "clear sky")
    private String iconCode;          // Weather icon code (e.g., "01d")
    private long timestamp;           // When this data was fetched (for cache expiration)
    ...
    /**
     * Get temperature as formatted string with unit
    ...
    /**
     * Get temperature as formatted string (Celsius by default)
     */
    ...
    public String getWeatherEmoji() {
        ...
        switch (weatherMain.toLowerCase()) {
            case "clear":
                return iconCode != null && iconCode.endsWith("n") ? "🌙" : "☀️";
            case "clouds":
                return "☁️";
            case "rain":
            case "drizzle":
    ...
    public boolean isFresh() {
        ...
        return ageMinutes < 30; // Fresh for 30 minutes
    }

    /**
     * Get age of this data in minutes
     */
    ...
    /**
     * Check if this weather data is valid (has required fields)
     */
    ...
    /**
     * Get tooltip text with detailed weather info
     */
    public String getTooltipText() {
        StringBuilder sb = new StringBuilder();
        sb.append(weatherDescription != null ? capitalize(weatherDescription) : weatherMain);
        sb.append("\n");
        sb.append("Temperature: ").append(getFormattedTemperature());
