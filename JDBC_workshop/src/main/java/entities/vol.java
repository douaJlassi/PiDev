...
public class vol extends service{
    ...
    public vol(String nom,String description,double prix,boolean disponibilite,int capacite,String numeroVol,String villeDepart,String villeArrivee,Date dateDepart,Date dateArrivee,String type,String imgUrl){
