...
public class MesAchatsController {
    ...
    private SaharDashboardController saharDashboardController;
    ...
    public void setDashboardController(SaharDashboardController controller) {
        this.saharDashboardController = controller;
    }
    ...
    private void handleBack() {
        if (saharDashboardController != null) {
            saharDashboardController.showDashboardView();
        }
    }
}